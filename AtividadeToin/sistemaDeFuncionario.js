...
class Funcionario {
    ...
    // Atribui o nome à propriedade _nome. A propriedade é protegida
    (encapsulada).
    this._nome = nome;
    // Atribui o salário à propriedade _salario. A propriedade é
    protegida (encapsulada).
    this._salario = salario;
    }
    // Método abstrato. Será implementado nas classes filhas.
    calcularBonus() {
    // Lança um erro se o método não for implementado pela classe filha.
